...
distinct absolute values among the elements of this array, namely 0, 1, 3, 5 and 6.
...
class TestExercise(unittest.TestCase):
    ...
    def test_sample(self):
        self.assertEqual(solution([1, 2, 2, 3, 3, 6, 6, 7, 8]), 6)

    def test_zero(self):
        self.assertEqual(solution([]), 0)

    def test_large(self):
        self.assertEqual(solution(list(range(-1000000, 1000001))), 1000001)
